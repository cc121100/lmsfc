<script type="text/javascript">
    ...
    $('#filterRuleListTbl').on('afterdelete.bjui.tablefixed', function(e) {
...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="${rc.contextPath}/filterRule/list" method="post">
        ...
        <div class="bjui-searchBar">
            ...
            <a href="${rc.contextPath}/filterRule/toEdit/new" class="btn btn-default" data-toggle="dialog" data-width="800" data-height="400" data-id="dialog-mask" data-mask="true">添加</a>
            ...
            <div class="pull-right">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu right" role="menu">
                        ...
                        <li class="divider"></li>
                        <li><a href="${rc.contextPath}/filterRule/deleteBatch" data-toggle="doajaxchecked" data-confirm-msg="确定要删除选中项吗？" data-idname="delids" data-group="ids">删除选中</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<div class="bjui-pageContent">
    <form action="${rc.contextPath}/filter/saveBatch" id="j_custom_form" class="pageForm" data-toggle="validate" method="post">
        <table id="filterRuleListTbl" data-toggle="tablefixed" data-width="100%" data-nowrap="true">
            <thead>
            <tr>
                <th>No.</th>
                <th data-order-field="name">Name</th>
                <th data-order-field="sourceDomain">Source Domain</th>
            ...
            <tr data-id="${c.id}">
                ...
                <td>${c.name}</td>
                <td>${c.sourceDomain}</td>
                <td>${c.updatedDt}</td>
                <td><input type="checkbox" name="ids" data-toggle="icheck" value="${c.id}"></td>
                <td>
                    <a href="${rc.contextPath}/filterRule/toEdit/${c.id}" class="btn btn-default" data-toggle="dialog" data-width="800" data-height="400" data-id="dialog-mask" data-mask="true">编辑</a>
                <#--<a href="${rc.contextPath}/filter/toEdit/${c.id}" class="btn btn-green" data-toggle="navtab" data-id="filterEditForm" data-title="编辑-${c.filterName}">编辑</a>-->
                    <a href="${rc.contextPath}/filterRule/delete/${c.id}" class="btn btn-red" data-toggle="doajax" data-confirm-msg="确定要删除该行信息吗？">删</a>
                </td>
            </tr>
