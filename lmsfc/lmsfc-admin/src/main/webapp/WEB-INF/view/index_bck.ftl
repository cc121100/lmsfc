...
<!--
<script src="${rc.contextPath}/js/bjui-core.js"></script>
<script src="${rc.contextPath}/js/bjui-regional.zh-CN.js"></script>
<script src="${rc.contextPath}/js/bjui-frag.js"></script>
<script src="${rc.contextPath}/js/bjui-extends.js"></script>
<script src="${rc.contextPath}/js/bjui-basedrag.js"></script>
<script src="${rc.contextPath}/js/bjui-slidebar.js"></script>
<script src="${rc.contextPath}/js/bjui-contextmenu.js"></script>
<script src="${rc.contextPath}/js/bjui-navtab.js"></script>
<script src="${rc.contextPath}/js/bjui-dialog.js"></script>
<script src="${rc.contextPath}/js/bjui-taskbar.js"></script>
<script src="${rc.contextPath}/js/bjui-ajax.js"></script>
<script src="${rc.contextPath}/js/bjui-alertmsg.js"></script>
<script src="${rc.contextPath}/js/bjui-pagination.js"></script>
<script src="${rc.contextPath}/js/bjui-util.date.js"></script>
<script src="${rc.contextPath}/js/bjui-datepicker.js"></script>
<script src="${rc.contextPath}/js/bjui-ajaxtab.js"></script>
<script src="${rc.contextPath}/js/bjui-tablefixed.js"></script>
<script src="${rc.contextPath}/js/bjui-tabledit.js"></script>
<script src="${rc.contextPath}/js/bjui-spinner.js"></script>
<script src="${rc.contextPath}/js/bjui-lookup.js"></script>
<script src="${rc.contextPath}/js/bjui-tags.js"></script>
<script src="${rc.contextPath}/js/bjui-upload.js"></script>
<script src="${rc.contextPath}/js/bjui-theme.js"></script>
<script src="${rc.contextPath}/js/bjui-initui.js"></script>
<script src="${rc.contextPath}/js/bjui-plugins.js"></script>
-->
<!-- plugins -->
            ...
            <ul class="bjui-navbar-right">
                ...
                <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">我的账户 <span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li class="divider"></li>
                        <li><a href="${rc.contextPath}/login.html" class="red">&nbsp;<span class="glyphicon glyphicon-off"></span> 注销登陆</a></li>
                    </ul>
                </li>
