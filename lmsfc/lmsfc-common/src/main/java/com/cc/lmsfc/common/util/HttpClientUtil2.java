...
//            FileInputStream instream = new FileInputStream(new File("/Users/tomchen/tomcat.keystore"));
//            try {
//                trustStore.load(instream, "Passw0rd!".toCharArray());
//            } finally {
//                instream.close();
//            }
//
...
//            String str1 = JsonUtils.toJson(map);
