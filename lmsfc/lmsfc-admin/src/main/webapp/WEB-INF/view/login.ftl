...
<head>
    ...
    <script src="${rc.contextPath}/js/sha256.js"></script>
    <link href="${rc.contextPath}/themes/css/bootstrap.min.css" rel="stylesheet">
    <style type="text/css">
        * {font-family: "Verdana", "Tahoma", "Lucida Grande", "Microsoft YaHei", "Hiragino Sans GB", sans-serif;}
        body {
            background: url(${rc.contextPath}/images/loginbg_01.jpg) no-repeat center center fixed;
...
//            });
        ...
        function choose_bg() {
            ...
            $('body').css('background-image', 'url(${rc.contextPath}/images/loginbg_0'+ bg +'.jpg)');
        }
    </script>
</head>
<body>
...
<div class="main_box">
    ...
    <div class="login_box">
        <div class="login_logo">
            <img src="${rc.contextPath}/images/logo.png" >
        </div>
        ...
        <div class="login_form">
            ...
            <form action="" id="login_form1" method="post">
