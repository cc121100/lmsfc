...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="${rc.contextPath}/filter/list" method="post">
        ...
        <div class="bjui-searchBar">
            ...
            <a href="${rc.contextPath}/filter/toEdit/new" class="btn btn-default" data-toggle="dialog" data-width="800" data-height="400" data-id="dialog-mask" data-mask="true">添加</a>
...
<div class="bjui-pageContent">
    <form action="${rc.contextPath}/filter/saveBatch" id="j_custom_form" class="pageForm" data-toggle="validate" method="post">
        <table id="filterListTbl" data-toggle="tablefixed" data-width="100%" data-nowrap="true">
            <thead>
                <tr>
                    <th>No.</th>
                    <th data-order-field="filterName">Filter Name</th>
                    <th>Filter Class Name</th>
                    <th>Filter Class Parameters</th>
            ...
            <#list pageResult.content as c>
                <tr data-id="${c.id}">
                    ...
                    <td>${c.filterName}</td>
                    <td>${c.filterClassName}</td>
                    <td>${c.filterClassParams}</td>
                    <td>${c.paramType}</td>
                    <td>${c.updatedDt}</td>
                    <td><input type="checkbox" name="ids" data-toggle="icheck" value="${c.id}"></td>
                    <td>
                        <a href="${rc.contextPath}/filter/toEdit/${c.id}" class="btn btn-default" data-toggle="dialog" data-width="800" data-height="400" data-id="dialog-mask" data-mask="true">编辑</a>
                        ...
                        <a href="${rc.contextPath}/filter/delete/${c.id}" class="btn btn-red" data-toggle="doajax" data-confirm-msg="确定要删除该行信息吗？">删</a>
                    </td>
                </tr>
